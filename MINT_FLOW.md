...
## Actions
* The threshold when Startale will need to act is set to +-100k.
...
* Bridge swapped token over the bridge to Ethereum (Swapper or champion)
* Champion swaps USDSC/USDC for wM on Uniswap v3 pool on Ethereum
* Champion uses M0-portal to mint/burn USDSC
* M0-portal sends USDSC/USDC back to Soneium Swapper account
